          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-5 text-3xl font-bold tracking-[-0.04em] sm:text-4xl lg:text-5xl">
                Turn ideas into
                <br />
                <GradientText>meaningful progress.</GradientText>
              </h2>

              <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-400 sm:text-base">
                Explore the Glow Ventures ecosystem or connect with our team
                to discuss your next project, campaign, or content requirement.
              </p>
            </div>
