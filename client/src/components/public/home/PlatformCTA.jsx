          ...
          <div className="relative grid items-center gap-9 lg:grid-cols-[1fr_auto] lg:gap-12">
            ...
            <div className="max-w-3xl">
              ...
              <p
                ...
                "
              >
                Sign in to explore your services, configure an order,
                manage your requirements, and keep your work organized
              ...
              >
                ...
                <span>One connected client experience.</span>
              </div>
            </div>
            ...
            <div className="lg:pr-1">
              ...
              <div className="mt-3 flex items-center justify-center gap-1.5 text-[10px] font-medium text-zinc-500 lg:justify-end">
