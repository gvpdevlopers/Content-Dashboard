...
const PlatformCTA = () => {
  return (
    <Section className="bg-[var(--color-surface-soft)]">
      <Reveal>
        <div className="relative overflow-hidden rounded-[32px] border border-zinc-200 bg-zinc-950 px-6 py-12 text-white shadow-[0_30px_80px_rgba(24,24,27,0.12)] sm:px-10 sm:py-16 lg:px-16 lg:py-18">
          {/* Background */}
          <div
            aria-hidden="true"
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto] lg:gap-12">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-5 text-3xl font-bold tracking-[-0.04em] sm:text-4xl lg:text-5xl">
                ...
                <GradientText>from brief to action.</GradientText>
              </h2>

              <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-400 sm:text-base">
                Sign in to explore your services, configure an order, manage
                your requirements, and keep your work organized.
              </p>
            </div>
