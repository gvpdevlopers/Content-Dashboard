...
const AdminOrderDetails = () => {
  ...
  */
  ...
  const handlePaymentStatusChange = async (event) => {
     ...
     */
    if (order.paymentMethod === "cod" && newPaymentStatus === "collected") {
  ...
  */
  ...
  const handleSaveNotes = async () => {
    ...
    try {
      ...
      setOrder((currentOrder) => ({
        ...currentOrder,
        notes: data.order?.notes !== undefined ? data.order.notes : adminNotes,
      }));
      ...
      <div className="mx-auto flex min-h-[60vh] max-w-xl items-center justify-center px-5 text-center">
        <div>
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-red-500/20 bg-red-500/10">
            <Package size={22} className="text-red-300" />
          </div>

          <h1 className="mt-5 text-xl font-medium">Unable to load order</h1>

          <p className="mt-2 text-sm leading-6 text-white/40">{error}</p>
  ...
  */
  ...
  const notesChanged = adminNotes !== (order.notes || "");
    ...
    <div className="mx-auto max-w-[1200px]">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <InfoCard icon={User} eyebrow="Client" title="Client Information">
          ...
          <InfoRow label="Username" value={order.client?.username || "—"} />
        </InfoCard>

        {/* =====================================================
    ORDER STATUS
====================================================== */}
        <InfoCard icon={Clipboard} eyebrow="Workflow" title="Order Status">
          ...
          <div className="mt-4">
            <label className="mb-2 block text-[10px] font-medium uppercase tracking-[0.15em] text-white/30">
              Update Status
            </label>
          ...
          <div className="mt-5 border-t border-white/[0.07] pt-5">
            ...
            <div className="relative">
              <select
                ...
                disabled={paymentLoading || order.paymentStatus === "collected"}
            ...
            {isCod && (
              <p className="mt-3 text-xs leading-5 text-white/30">
                COD payment is marked as collected only after successful PIN
                verification.
              </p>
            )}
          </div>
          ...
          >
            ...
            {hasCodPin ? (
              <div className="mt-5">
                ...
                <p className="mt-3 text-xs leading-5 text-white/30">
                  Share this PIN with the payment collector. The client will
                  enter the PIN from their order page.
                </p>
              </div>
            ) : (
              <div className="mt-5">
            ...
            {order.codPinVerifiedAt && (
              <div className="mt-5 border-t border-white/[0.07] pt-4">
                <InfoRow
                  label="PIN Verified"
                  value={formatDateTime(order.codPinVerifiedAt)}
                />
              </div>
            )}
        ...
        <InfoCard icon={FileText} eyebrow="Internal" title="Admin Notes">
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              disabled={notesLoading || !notesChanged}
        ...
        <div className="mt-6 rounded-[24px] border border-white/10 bg-[#111111] p-6 sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="mt-1 text-lg font-medium">Saved Notes</h2>
            </div>
          </div>
